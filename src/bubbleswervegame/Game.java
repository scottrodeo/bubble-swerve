...
public class Game {
	...
	private void spawnNewPiece() {
	    ...
	    switch(random){
	        case 1:
	        	piece = new BubbloidBar1(initialRow, initialColumn, grid);    
	            break;
	        case 2:
	            piece = new BubbloidBar3(initialRow, initialColumn, grid);
	            break;
	        case 3:
	        	piece = new BubbloidL5(initialRow, initialColumn, grid); 
	            break;
	        case 4:
	            piece = new BubbloidBar2(initialRow, initialColumn, grid);       
	            break;
	        case 5:
	            piece = new BubbloidCross5(initialRow, initialColumn, grid);   
	            break;
	        case 6:
	            piece = new BubbloidV3(initialRow, initialColumn, grid);          
	            break;
	        case 7:
	            piece = new BubbloidJ5(initialRow, initialColumn, grid);     
	            break;
	        case 8:
	            piece = new BubbloidRectangle6(initialRow, initialColumn, grid);     
	            break;    
	        case 9:
	            piece = new BubbloidVDiscon2(initialRow, initialColumn, grid);     
	            break;	            
	    }
	}
